 ...
 * Buttons
 */
$GLOBALS['TL_LANG']['tl_cds']['new']        = array('Neue Ausschreibung', 'Neue Ausschreibung erstellen');
$GLOBALS['TL_LANG']['tl_cds']['show']       = array('Ausschreibungs Detail', 'Zeie die Ausschreibung im Detail ID %s');
$GLOBALS['TL_LANG']['tl_cds']['edit']       = array('Ausschreibung ändern', 'Verändere die Ausschreibungs ID %s');
$GLOBALS['TL_LANG']['tl_cds']['editheader'] = array('Edit album settings', 'Verändere die Ausschreibung settings ID %s');
$GLOBALS['TL_LANG']['tl_cds']['copy']       = array('Copy album', 'Ausschreibung kopieren ID %s');
$GLOBALS['TL_LANG']['tl_cds']['delete']     = array('Delete album', 'Ausschreibung löschen ID %s');
